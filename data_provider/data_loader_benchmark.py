...
class UTSDDatasetBenchmark(Dataset):
    def __init__(self, root_path, flag='train', size=None, features='M', data_path='ETTh1.csv',
        ...
        self.augment_resolution_dic = {
            'aus_electricity_demand': [1, 2, 48],
            'bitcoin': [1],
            'kaggle_web_traffic': [1],
            'kdd_cup_2018': [1],
            'london_smart_meters': [1, 2, 48],
            'LOOP_SEATTLE': [1, 2, 3, 6, 12],
            'LOS_LOOP': [1, 2, 3, 6, 12],
            'monash_weather': [1],
            'nn5': [1],
            'pems_bay': [1, 2, 3, 6, 12],
            ...
            'Q-TRAFFIC': [1, 2, 4],
            'saugeenday': [1],
            'solar_4_seconds': [1, 150, 225, 450, 900],
            'solar_10_minutes': [1, 3, 6],
            'sunspot': [1],
            'SZ_TAXI': [1, 2],
            'us_births': [1],
            'wind_4_seconds': [1, 150, 225, 450, 900],
            'wind_farms_minutely': [1, 10, 15, 30, 60],
        }
        self.__read_data__()
