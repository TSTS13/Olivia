...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Olivia')

    # basic config
    parser.add_argument('--task_name', type=str, default='long_term_forecast',
                        help='task name, options:[long_term_forecast, long_term_forecast_chronos]')
    ...
    parser.add_argument('--model', type=str, default='Olivia', help='model name, options: [Olivia_CL, Olivia]')
    ...
    parser.add_argument('--setting', type=str, default='experiment setting',
                        help='randomly initialize an experimental setup')
    ...
    parser.add_argument('--horizon_lengths', type=list, default=[1, 96, 192, 336, 720],
                        help='prediction sequence length list')
    ...
    parser.add_argument('--lradj', type=str, default='type1', choices=['constant_with_warmup'],
